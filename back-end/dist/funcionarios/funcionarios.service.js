    ...
    async findByName(nome) {
        try {
            ...
            if (!funcionarios || funcionarios.length === 0) {
                throw new common_1.HttpException('Nenhum funcionário encontrado com este nome', common_1.HttpStatus.NOT_FOUND);
            }
            return funcionarios;
        }
        catch (error) {
            ...
            throw new common_1.HttpException('Erro ao buscar funcionários pelo nome', common_1.HttpStatus.BAD_REQUEST);
        }
    }
