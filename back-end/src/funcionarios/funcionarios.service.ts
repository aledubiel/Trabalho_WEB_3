  ...
  async findOne(id: number) {
    ...
    try {
      ...
      if (!funcionarios || funcionarios.length === 0) {
        throw new HttpException('Nenhum funcionário encontrado com este nome', HttpStatus.NOT_FOUND);
      }
      ...
      throw new HttpException('Erro ao buscar funcionários pelo nome', HttpStatus.BAD_REQUEST);
    }
  }
